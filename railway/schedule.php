...
{
	echo "
<tr><td>".($temp+1)."</td><td>".$stations[$temp]."</td><td>".$departure[$temp]."</td><td>".$stations[$temp+1]."</td><td>".$arrival[$temp+1]."</td><td>".($distance[$temp+1]-$distance[$temp])."</td><td><a href=\"http://127.0.0.1:8080/railway/seat_plan.php?trainno=".$_GET["trainno"]."&sp=".$stations[$temp]."&dp=".$stations[$temp+1]."\"><button>Seat Plan</button></a></td></tr>
";
$temp+=1;
}
echo "</table>";

echo " <br><a href=\"http://127.0.0.1:8080/railway/show_trains.php\">Go Back to Train Menu!!!</a><br> ";
